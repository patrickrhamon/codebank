...
type PaymentServiceClient interface {
	Payment(ctx context.Context, in *PaymenteRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *paymentServiceClient) Payment(ctx context.Context, in *PaymenteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type PaymentServiceServer interface {
	Payment(context.Context, *PaymenteRequest) (*empty.Empty, error)
...
func (UnimplementedPaymentServiceServer) Payment(context.Context, *PaymenteRequest) (*empty.Empty, error) {
...
func _PaymentService_Payment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).Payment(ctx, req.(*PaymenteRequest))
	}
